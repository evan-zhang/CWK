...
实测（2026-09-05 重摄取 r2）：三份 v2 原件 sha 各不相同（`796f38b8…` / `84b606e9…` /
`d7db8ffa…`，15,645B / 27,574B / 454B，均 matches_index=true），壳检测生效，
回执见 `receipts/acceptance-20260905.json`。表中预估字节数为 get-full-content
载荷长度，落库以抽取后的 UTF-8 正文为准。
